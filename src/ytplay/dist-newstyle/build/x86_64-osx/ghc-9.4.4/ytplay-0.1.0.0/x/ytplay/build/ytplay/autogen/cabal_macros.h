...
/* package ytplay-0.1.0.0 */
#ifndef VERSION_ytplay
#define VERSION_ytplay "0.1.0.0"
#endif /* VERSION_ytplay */
#ifndef MIN_VERSION_ytplay
#define MIN_VERSION_ytplay(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ytplay */
...
#define CURRENT_COMPONENT_ID "ytplay-0.1.0.0-inplace-ytplay"
